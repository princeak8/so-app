...
import Geregu from '@/components/PowerStation2/Geregu';
import GereguNipp from '@/components/PowerStation2/GereguNipp';
import Ihovbor from '@/components/PowerStation2/Ihovbor';
import Azura from '@/components/PowerStation2/Azura';
import AfamIV from '@/components/PowerStation2/AfamIV';
import AfamV from '@/components/PowerStation2/AfamV';
import AfamVi from '@/components/PowerStation2/AfamVi';
import Dadinkowa from '@/components/PowerStation2/Dadinkowa';
import Odukpani from '@/components/PowerStation2/Odukpani';
import IkotEkpene from '@/components/PowerStation2/IkotEkpene';
import Jebba from '@/components/PowerStation2/Jebba';
import OmotoshoNipp from '@/components/PowerStation2/OmotoshoNipp';
import OmotoshoGas from '@/components/PowerStation2/OmotoshoGas';
import Omoku from '@/components/PowerStation2/Omoku';
import Gbarain from '@/components/PowerStation2/Gbarain';
import Delta2 from '@/components/PowerStation2/Delta2';
import Delta3 from '@/components/PowerStation2/Delta3';
import Delta4 from '@/components/PowerStation2/Delta4';
import RiversIpp from '@/components/PowerStation2/RiversIpp';
import SapeleNipp from '@/components/PowerStation2/SapeleNipp';
import SapeleSteam from '@/components/PowerStation2/SapeleSteam';
import Transamadi from '@/components/PowerStation2/Transamadi';
import Egbin from '@/components/PowerStation2/Egbin';
import Okpai from '@/components/PowerStation2/Okpai';
import Shiroro from '@/components/PowerStation2/Shiroro';
import Alaoji from '@/components/PowerStation2/Alaoji';
import Kainji from '@/components/PowerStation2/Kainji';
import OlorunsogoGas from '@/components/PowerStation2/OlorunsogoGas';
import OlorunsogoNipp from '@/components/PowerStation2/OlorunsogoNipp';
import ParasEnergy from '@/components/PowerStation2/ParasEnergy';
import Ibom from '@/components/PowerStation2/Ibom';
