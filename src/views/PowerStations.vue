...
import Taopex from '@/components/PowerStation/Taopex';
...
export default {
  ...
  components: { 
    ...
    RiversIpp, SapeleNipp, SapeleSteam, Transamadi, Egbin, Okpai, Shiroro, Alaoji, Kainji, OlorunsogoGas, OlorunsogoNipp, ParasEnergy, Ibom, Jebba, Zungeru, Taopex
  },
  ...
  computed: {
    ...
    stations() {
      ...
      return [
        ...
        {
          name: "OmotoshoGas",
          station: this.omotoshoGasStation,
          totalFn: this.getStationTotal,
          ref: "OmotoshoGas",
        },
        {
          name: "OmotoshoNipp",
          station: this.omotoshoNipp,
          totalFn: this.getStationTotal,
          ref: "OmotoshoNipp",
        },
        {
          name: "ParasEnergy",
          station: this.parasEnergy,
          totalFn: this.getStationTotal,
          ref: "ParasEnergy",
        },
        {
          name: "RiversIpp",
          station: this.riversIpp,
          totalFn: this.getStationTotal,
          ref: "RiversIpp",
        },
        {
          name: "SapeleNipp",
          station: this.sapeleNipp,
          totalFn: this.getStationTotal,
          ref: "SapeleNipp",
        },
        {
          name: "SapeleSteam",
          station: this.sapeleSteam,
          totalFn: this.getStationTotal,
          ref: "SapeleSteam",
        },
        {
        ...
        {
            name: "Taopex", station: this.taopex,   totalFn: this.getStationTotal, ref: "Taopex",
        },
        {
    ...
    pStations() {
      ...
      this.pStations.forEach((station) => {
        ...
        switch (station.id) {
          case "gereguPs":
            this.geregu = station;
            this.gereguNipp = station;
            break;
          case "ihovborNippPs":
            this.ihovbor = station;
            this.azura = station;
            break;
          case "afamIv_vPs":
            this.afamIV = station;
          ...
          case "odukpaniNippPs":
            this.odukpani = station;
            break;
          case "okpaiGs":
            this.okpai = station;
            break;
          case "olorunsogo1":
            this.olorunsogo1 = station;
            break;
          case "olorunsogoPhase1Gs":
          ...
          case "omotoshoNippPs":
            ...
            break;
          case "omotosho1":
            this.omotosho1 = station;
            break;
          case "omotosho2":
            this.omotosho2 = station;
            break;
          case "parasEnergyPs":
  ...
  methods: {
    ...
    unitBgColor(unit) {
      return unit.powerData &&
        unit.powerData.mw &&
        Math.abs(unit.powerData.mw) > 0
        ? "green"
        : "grey";
    },
    getPsData(id) {
    ...
    getStationTotal(station, value) {
      switch (station) {
        case "AfamIV":
          this.$set(this.mwTotal, "AfamIV", value.mw);
          this.$set(this.mxTotal, "AfamIV", value.mvar);
          break;
        case "AfamV":
          this.$set(this.mwTotal, "AfamV", value.mw);
          this.$set(this.mxTotal, "AfamV", value.mvar);
          break;
        case "AfamVI":
          this.$set(this.mwTotal, "AfamVi", value.mw);
          this.$set(this.mxTotal, "AfamVi", value.mvar);
          break;
        case "Alaoji":
          this.$set(this.mwTotal, "Alaoji", value.mw);
          this.$set(this.mxTotal, "Alaoji", value.mvar);
          break;
        case "Azura":
          this.$set(this.mwTotal, "Azura", value.mw);
          this.$set(this.mxTotal, "Azura", value.mvar);
          break;
        case "Dadinkowa":
          this.$set(this.mwTotal, "Dadinkowa", value.mw);
          this.$set(this.mxTotal, "Dadinkowa", value.mvar);
          break;
        case "Delta2":
          this.$set(this.mwTotal, "Delta2", value.mw);
          this.$set(this.mxTotal, "Delta2", value.mvar);
          break;
        case "Delta3":
          this.$set(this.mwTotal, "Delta3", value.mw);
          this.$set(this.mxTotal, "Delta3", value.mvar);
          break;
        case "Delta4":
          this.$set(this.mwTotal, "Delta4", value.mw);
          this.$set(this.mxTotal, "Delta4", value.mvar);
          break;
        case "Egbin":
          this.$set(this.mwTotal, "Egbin", value.mw);
          this.$set(this.mxTotal, "Egbin", value.mvar);
          break;
        case "Gbarain":
          this.$set(this.mwTotal, "Gbarain", value.mw);
          this.$set(this.mxTotal, "Gbarain", value.mvar);
          break;
        case "Geregu":
          this.$set(this.mwTotal, "Geregu", value.mw);
          this.$set(this.mxTotal, "Geregu", value.mvar);
          break;
        case "GereguNipp":
          this.$set(this.mwTotal, "GereguNipp", value.mw);
          this.$set(this.mxTotal, "GereguNipp", value.mvar);
          break;
        case "Ibom":
          this.$set(this.mwTotal, "Ibom", value.mw);
          this.$set(this.mxTotal, "Ibom", value.mvar);
          break;
        case "Ihovbor":
          this.$set(this.mwTotal, "Ihovbor", value.mw);
          this.$set(this.mxTotal, "Ihovbor", value.mvar);
          break;
        case "Jebba":
          this.$set(this.mwTotal, "Jebba", value.mw);
          this.$set(this.mxTotal, "Jebba", value.mvar);
          break;
        case "Kainji":
          this.$set(this.mwTotal, "Kainji", value.mw);
          this.$set(this.mxTotal, "Kainji", value.mvar);
          break;
        case "Odukpani":
          this.$set(this.mwTotal, "Odukpani", value.mw);
          this.$set(this.mxTotal, "Odukpani", value.mvar);
          break;
        case "Okpai":
          this.$set(this.mwTotal, "Okpai", value.mw);
          this.$set(this.mxTotal, "Okpai", value.mvar);
          break;
        case "OlorunsogoGas":
          this.$set(this.mwTotal, "OlorunsogoGas", value.mw);
          this.$set(this.mxTotal, "OlorunsogoGas", value.mvar);
          break;
        case "OlorunsogoNipp":
          this.$set(this.mwTotal, "OlorunsogoNipp", value.mw);
          this.$set(this.mxTotal, "OlorunsogoNipp", value.mvar);
          break;
        case "Omoku":
          this.$set(this.mwTotal, "Omoku", value.mw);
          this.$set(this.mxTotal, "Omoku", value.mvar);
          break;
        case "OmotoshoGas":
          this.$set(this.mwTotal, "OmotoshoGas", value.mw);
          this.$set(this.mxTotal, "OmotoshoGas", value.mvar);
          break;
        case "OmotoshoNipp":
          this.$set(this.mwTotal, "OmotoshoNipp", value.mw);
          this.$set(this.mxTotal, "OmotoshoNipp", value.mvar);
          break;
        case "ParasEnergy":
          this.$set(this.mwTotal, "ParasEnergy", value.mw);
          this.$set(this.mxTotal, "ParasEnergy", value.mvar);
          break;
        case "RiversIpp":
          this.$set(this.mwTotal, "RiversIpp", value.mw);
          this.$set(this.mxTotal, "RiversIpp", value.mvar);
          break;
        case "SapeleNipp":
          this.$set(this.mwTotal, "SapeleNipp", value.mw);
          this.$set(this.mxTotal, "SapeleNipp", value.mvar);
          break;
        case "SapeleSteam":
          this.$set(this.mwTotal, "SapeleSteam", value.mw);
          this.$set(this.mxTotal, "SapeleSteam", value.mvar);
          break;
        case "Shiroro":
          this.$set(this.mwTotal, "Shiroro", value.mw);
          this.$set(this.mxTotal, "Shiroro", value.mvar);
          break;
        case "Taopex":
          this.$set(this.mwTotal, "Taopex", value.mw);
          this.$set(this.mxTotal, "Taopex", value.mvar);
          break;
        case "Transamadi":
