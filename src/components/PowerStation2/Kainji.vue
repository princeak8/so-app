<template>
    <tr>
     ...
     <!-- {
         "id":"kainjiTs","t":"22:51:30", 
         "lines":[
                    {"id":"k1j","td":{"mw":92.91,"A":164.24,"V":332.22,"mvar":-15.73}},
                    {"id":"k2j","td":{"mw":94.02,"A":164.62,"V":334.34,"mvar":-14.29}},
                    {"id":"k3r","td":{"mw":203.12,"A":359.62,"V":333.70,"mvar":-44.09}},
                    {"id":"k1f","td":{"mw": 9.66,"A":17.28,"V":328.60,"mvar": 1.86}}
                ]
     } -->
</template>
  ...
  computed: {
      ...
      pData() {
          ...
          let statusCheck = '';
            ...
            this.$emit('total', 'Kainji', totalData);
            return totalData;
      },
      statusName() {
          switch(this.status) {
